...
var require_object_property_is_enumerable = __commonJS({
  "node_modules/core-js/internals/object-property-is-enumerable.js"(exports) {
    ...
    var NASHORN_BUG = getOwnPropertyDescriptor3 && !$propertyIsEnumerable.call({
      1: 2
    }, 1);
  ...
  "node_modules/core-js/internals/microtask.js"(exports, module) {
    ...
    if (!microtask) {
      ...
      if (!IS_IOS && !IS_NODE2 && !IS_WEBOS_WEBKIT && MutationObserver && document2) {
        ...
        new MutationObserver(flush).observe(node2, {
          characterData: true
        });
        notify = function() {
      ...
      try {
        ...
        if (then) {
          microtask(function() {
            ...
            try {
              call4(then, value, bind(internalResolve, wrapper, state), bind(internalReject, wrapper, state));
            } catch (error) {
  ...
  "node_modules/core-js/modules/es.promise.catch.js"() {
    ...
    if (!IS_PURE3 && isCallable2(NativePromiseConstructor)) {
      ...
      if (NativePromisePrototype["catch"] !== method) {
        defineBuiltIn2(NativePromisePrototype, "catch", method, {
          unsafe: true
        });
      }
    }
...
var require_es_promise_resolve = __commonJS({
  "node_modules/core-js/modules/es.promise.resolve.js"() {
    ...
    $8({
      target: "Promise",
      stat: true,
      forced: IS_PURE3 || FORCED_PROMISE_CONSTRUCTOR
    }, {
          ...
          if ($exec === regexpExec || $exec === RegExpPrototype2.exec) {
            if (DELEGATES_TO_SYMBOL && !forceStringMethod) {
              return {
                ...
                value: call4(nativeRegExpMethod, regexp, str, arg2)
              };
            }
            return {
              done: true,
              value: call4(nativeMethod, str, regexp, arg2)
            };
          }
          return {
            done: false
  ...
  "node_modules/core-js/internals/iterator-define.js"(exports, module) {
    ...
    module.exports = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED3) {
      ...
      if ((!IS_PURE3 || FORCED3) && IterablePrototype[ITERATOR2] !== defaultIterator) {
        defineBuiltIn2(IterablePrototype, ITERATOR2, defaultIterator, {
          name: DEFAULT
        });
      }
  ...
  "node_modules/rgbcolor/index.js"(exports, module) {
    module.exports = function(color_string) {
      ...
      var color_defs = [{
        ...
        example: ["#fb0", "f0f"],
        process: function(bits2) {
          return [parseInt(bits2[1] + bits2[1], 16), parseInt(bits2[2] + bits2[2], 16), parseInt(bits2[3] + bits2[3], 16)];
        }
      }];
...
$3({
  target: "String",
  proto: true,
  forced: !MDN_POLYFILL_BUG2 && !CORRECT_IS_REGEXP_LOGIC2
}, {
...
var t = function(r2, e2) {
  return (t = Object.setPrototypeOf || {
    __proto__: []
  } instanceof Array && function(t2, r3) {
    t2.__proto__ = r3;
  } || function(t2, r3) {
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-KFP7AVLL.js.map
